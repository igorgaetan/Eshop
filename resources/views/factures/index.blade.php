    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item ative">Tous</li>
            </ol>
            </nav>
        </div>
            ...
            <div class="row">
              ...
              <!-- Revenue-->
                <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Recette<span>|  Aujourd'hui
                        </span></h5>
                        ...
                        <div class="ps-3">
                            ...
                            <span class="text-success small pt-1 fw-bold">{{$total}}</span> <span class="text-muted small pt-2 ps-1">Factures</span>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Paiement <span> |
                            ...
                            @if (isset(request()->typeFac) && request()->typeFac==0)
                              Cash

                            @elseif (request()->typeFac==1)
                            Tontine

                            @elseif (request()->typeFac==2)
                              Bon achat

                            @elseif (request()->typeFac==3)
                              OM

                            @elseif (request()->typeFac==4)
                              Momo

                            @elseif (request()->typeFac==5)
                              Autre
                            @else
                              Tout
                            @endif
                        ...
                        <div>
                          <form class="row">
                              ...
                              <div class="col-6">
                                <button type="submit" class="btn link-primary"> Rechercher </button>
                              </div>
                          </form>
                        </div>
                    </div>
