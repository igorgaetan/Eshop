    ...
    <main id="main" class="main">
      <div class="pagetitle">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">Commandes no {{$commande->id}}</li>
                ...
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('storeLigneCom',["commande"=>$commande])}}" id="formSubmit" method="POST">
                                  @csrf
                                  <div class="row mb-3">
                                  ...
                                  <button type="submit" class="btn btn-primary w-100" id="addProduit" disabled> Ajouter </button>
                      ...
                      $.ajax({
                          ...
                          success: function(response) {
                              ...
                              if(response.success){
                                  ...
                                  //Gestions des tailles
                                  let tailles=response.tailles;
                                  let tailleList=document.querySelector('#taille');
                                  tailleList.innerHTML="";
                                  tailles.forEach(function(taille,index){
                                    tailleList.append(new Option(taille['sizeName'],taille['sizeName']));
                                  })

                                  //Gestions des couleurs
                                  let couleurs=response.couleurs;
                                  let couleurList=document.querySelector('#couleur');
                                  couleurList.innerHTML="";
                                  couleurs.forEach(function(couleur,index){
                                    couleurList.append(new Option(couleur['colorName'],couleur['colorName']));
                                  })
